# repackaged libs
Single-file header-only libs written by other people that are public domain (except minimp3fixed.h which is the old LGPL version) and modified by RandoOnSteam <randoonsteam@gmail.com>.
